...
public class ProxyHandler {
    ...
    private final static Integer DEFAULT_MAX_POOL_SIZE = 100; // README : be careful on how you dimension your connection pool
    ...
    private void checkConfig() {
        ...
        if (clientConfig.getString("host") == null) {
            throw new IllegalArgumentException("You should specify a host to forward incoming requests too, eg: {\"client\":{\"host\":\"com.foo.bar\"}}");
        }
        ...
        /*
         * README : add your client options here, like :
         * ssl configuration, tcpkeepalive, ...
         */
    }
